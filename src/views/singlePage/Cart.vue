<template>
  <div>
    ...
    <div>
      ...
      <!-- 亮哥发量
    <span style="color:red">{{$store.getters.getFa}}</span>
    <mt-button @click="sub">掉一个</mt-button> -->
    ...
    loadMore() {
      ...
      this.axios.get(url).then(res => {
        ...
        if (res.data.code == -2) {
          ...
          // 5.1获取服务器中购物车列表,临时保存变量rows
          var rows = res.data.data;
          // 5.2创建循环遍历数组中每一个商品并且添加cd属性
          //  表示商品是否选中状态
