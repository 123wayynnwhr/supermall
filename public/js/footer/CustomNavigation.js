...
var navigation = {
    ...
    SetRight: function(obj, categoryId) {
        if (obj[0] != undefined) $("#" + categoryId).find(".subAG").html(obj[0].content);
    },
    fadeNav: function() {
        ...
        $('#nav>dl').mouseleave(function() {
            $(this).children('dd').find(".submenu").animate({
                opacity: 0
            },
            100,
            function() {
