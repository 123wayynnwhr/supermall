var Tool = {
        ...
        loding: function () {
            var w = $(window).width(),
                h = $(window).height();
            $('body').append("<div class='loading_toplayer'></div><img class='loading_img' src='/Resources/images/loading.gif'>");
        ...
        loding2: function (id) {
            var w = $(window).width(),
                h = $(window).height();
            $("#" + id).append("<div class='loading_toplayer'></div><img class='loading_img' src='/Resources/images/loading.gif'>");
            var l = (w - $('.loading_img').width()) / 2,
                t = (h - $('.loading_img').height() - 100) / 2;
            $('.loading_toplayer').css({ width: w, height: h });
